...
int longestBitonicSequence(vector<int> &arr, int n)
{
    ...
    // dp1[i] stores the length of the longest increasing subsequence ending at arr[i]
    vector<int> dp1(n, 1);

    // dp2[i] stores the length of the longest decreasing subsequence ending at arr[i]
    vector<int> dp2(n, 1);
